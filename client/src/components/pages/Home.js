...
export default function Home() {
  return (
    <div className="container-fluid" id="aboutMe">
      ...
      <button>
        <a className="nameHover" href="https://reactjs.org/" target="_blank" rel="noreferrer">
        ...
        <button>
        <a className="nameHover" href="https://www.javascript.com/" target="_blank" rel="noreferrer">
        ...
        <button>
        <a className="nameHover" href="https://developer.mozilla.org/en-US/docs/Web/CSS" target="_blank" rel="noreferrer">
        ...
        <button>
        <a className="nameHover" href="https://developer.mozilla.org/en-US/docs/Learn/HTML" target="_blank" rel="noreferrer">
        ...
        <button>
        <a className="nameHover" href="https://nodejs.org/en/" target="_blank" rel="noreferrer">
        ...
        <button>
        <a className="nameHover" href="https://expressjs.com/" target="_blank" rel="noreferrer">
        ...
        <button>
        <a className="nameHover" href="https://graphql.org/" target="_blank" rel="noreferrer">
        ...
        <button>
        <a className="nameHover" href="https://jestjs.io/" target="_blank" rel="noreferrer">
        ...
        <button>
        <a className="nameHover" href="https://www.mongodb.com/" target="_blank" rel="noreferrer">
        ...
        <button>
        <a className="nameHover" href="https://www.mysql.com/" target="_blank" rel="noreferrer">
        ...
        <button>
        <a className="nameHover" href="https://getbootstrap.com/" target="_blank" rel="noreferrer">
        ...
        <button>
        <a className="nameHover" href="https://www.npmjs.com/" target="_blank" rel="noreferrer">
